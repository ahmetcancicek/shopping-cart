...
INSERT IGNORE INTO customer(id,first_name, last_name, user_id) VALUES(2000,"Bill","King",(SELECT id FROM users WHERE email="billking@email.com"));
INSERT IGNORE INTO cart(id, total_price, customer_id) VALUES(2000,0,(SELECT id FROM customer WHERE user_id=(SELECT id FROM users WHERE email="billking@email.com")));
