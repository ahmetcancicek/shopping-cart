...
VALUES (1, 1, "georgehouse@email.com", "$2a$10$E.nGzmuccDIDu6ywkiZGXezuw/HulzC.czympJow0lAN.EGtavCeu", "georgehouse");
...
VALUES ((SELECT id FROM users WHERE username = "georgehouse"), (SELECT id FROM role WHERE name = "ADMIN"));
